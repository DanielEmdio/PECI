...
COPY public.personal_trainers (id, username, password, token, name, description, tags, photo, price, slots) FROM stdin;
42	chris	123	\N	Chris Heria	Weight lifting and calisthenics is where i shine	Calisthenics,Weight Lifting	chris_heria.jpg	40€ - monthly	7
1	igor	123	\N	Igor Voitenko	Get consistent	Calisthenics	igor.jpg	30€ - monthly	5
18	uni	123	\N	UA	Get your workout done in the comfort of your home	Professional, Flexibliity	ua.png	25€ - monthly	10
\.
...
3	pullUps.mp4	Wider back workout	Pull ups challenge to widen your back	Back	September 14, 2023	1	1	thumbnails/pullUps.png
2	Boyka_Workout.mp4	The Yuri Boyka Workout	Arms killer workout	Biceps,Triceps,Chest	June 29, 2022	1	1	thumbnails/boyka_workout.png
1	arms_workout.mp4	arms workout	Good workout for you arms	Biceps,Triceps	November 2, 2023	0	1	thumbnails/arms_workout.png
33	uatreino1.mp4	Full body workout	Good workout for beginners	Upper,Lower 	January 25, 2023	0	18	thumbnails/uatreino1.png
27	uatreino3.mp4	Leg day	A legs focused workout with some abs in between	Legs,Abs	May 13, 2023	1	18	thumbnails/uatreino3.png
32	uatreino2.mp4	Upper body workout	A good all-around upper body target workout	Biceps,Triceps,Chest,Shoulders	February 7, 2023	1	18	thumbnails/uatreino2.png
\.
...
SELECT pg_catalog.setval('public."PTs_id_seq"', 42, true);
...
SELECT pg_catalog.setval('public."Video_id_seq"', 41, true);
...
--
-- Name: videos VideoID_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.videos
    ADD CONSTRAINT "VideoID_pkey" PRIMARY KEY (id);
